...
function AndroidQuesiton() {
  ...
  useEffect(() => {
    try {
      axios.get(`${BaseUrl}/api/questions?category=5`)
        .then((res) => {
          console.log(res);
  ...
  return (
    ...
    <>
      ...
      <QuestionPageLayout>
        <TitleBox>
          <QuestionPageTitle>Android</QuestionPageTitle>
...
export default AndroidQuesiton
