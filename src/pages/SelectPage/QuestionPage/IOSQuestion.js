...
import IOSAccodian from '../../../components/Accodian/accodians/iosaccodian';

function IOSQuesiton() {
  ...
  return (
    <>
      ...
      <QuestionPageLayout>
        <TitleBox>
          <QuestionPageTitle>IOS</QuestionPageTitle>
