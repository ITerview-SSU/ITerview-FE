...
function UIUXRandom() {
  ...
  useEffect(() => {
    try {
      axios.get(`${BaseUrl}/api/questions/random?category=6`)
      .then((res) => {
        ...
        {isRandom ? 
           <TitleBox>
             <TitleFlex>
                ...
                <QuestionTitle>UI/UX Designer</QuestionTitle>
              </TitleFlex>
                <DescribeStyle>
            ...
            <TitleBox2>
                ...
                <QuestionTitle2>UI/UX Designer</QuestionTitle2>
                <Header>
                    <QImgStyle src={QImg} />
