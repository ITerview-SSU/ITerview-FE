...
function AndroidRandom() {
  ...
  useEffect(() => {
    try {
      axios.get(`${BaseUrl}/api/questions/random?category=5`)
      .then((res) => {
        ...
        {isRandom ? 
           <TitleBox>
             <TitleFlex>
                ...
                <QuestionTitle>Android</QuestionTitle>
              </TitleFlex>
                <DescribeStyle>
            ...
            <TitleBox2>
                ...
                <QuestionTitle2>Android</QuestionTitle2>
                <Header>
                    <QImgStyle src={QImg} />
